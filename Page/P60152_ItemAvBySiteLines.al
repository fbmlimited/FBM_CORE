page 60152 FBM_ItemAvBySiteLines
{
    Caption = 'Lines';
    DeleteAllowed = false;
    Editable = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Item.Inventory"; Item.FBM_Inventory_FF)
                {
                    ApplicationArea = Location;
                    Caption = 'Inventory';
                    DecimalPlaces = 0 : 5;
    ...
    begin
        ...
        LocationCode := rec."Site Code";
        Item.SetRange(FBM_SiteFilter, rec."Site Code");
    ...
    local procedure OnAfterCalcAvailQuantities(var Location: Record FBM_CustomerSite_C; var Item: Record Item; var GrossRequirement: Decimal; var PlannedOrderRcpt: Decimal; var ScheduledRcpt: Decimal; var PlannedOrderReleases: Decimal; var ProjAvailableBalance: Decimal; var ExpectedInventory: Decimal; var QtyAvailable: Decimal; var AvailableInventory: Decimal)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeSet(var Location: Record FBM_CustomerSite_C; var Item: Record Item; NewAmountType: Option "Net Change","Balance at Date");
    begin
    end;
}
