page 60151 FBM_ItemAvBySite
{
    Caption = 'Item Availability by Site';
    ...
    layout
    {
        area(content)
        {
            ...
            part(ItemAvailLocLines; FBM_ItemAvBySiteLines)
            {
                ApplicationArea = Location;
                Editable = false;
            }
    ...
    begin
        ...
        LastLocation := Location."Site Code";
    end;
    ...
    procedure GetLastLocation(): Code[20]
    begin
        exit(LastLocation);
    end;
