page 60121 "FBM_Aged Accounts by Months_CO"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Group)
            {
                ...
                { }
                field("Current Month"; rec."FBM_Current Month")
                {
                    BlankZero = true;
                }
                field("1 Month"; rec."FBM_1 Month")
                {
                    BlankZero = true;
                }
                field("2 Months"; rec."FBM_2 Months")
                {
                    BlankZero = true;
                }
                field("3 Months"; rec."FBM_3 Months")
                {
                    BlankZero = true;
                }
                field("4 Months"; rec."FBM_4 Months")
                {
                    BlankZero = true;
                }
                field("5 Months"; rec."FBM_5 Months")
                {
                    BlankZero = true;
                }
                field("6 Months"; rec."FBM_6 Months")
                {
                    BlankZero = true;
                }
                field("7 Months"; rec."FBM_7 Months")
                {
                    BlankZero = true;
                }
                field("8 Months"; rec."FBM_8 Months")
                {
                    BlankZero = true;
                }
                field("9 Months"; rec."FBM_9 Months")
                {
                    BlankZero = true;
                }
                field("10 Months"; rec."FBM_10 Months")
                {
                    BlankZero = true;
                }
                field("11 Months"; rec."FBM_11 Months")
                {
                    BlankZero = true;
                }
                field("12 Months"; rec."FBM_12 Months")
                {
                    BlankZero = true;
                }
                field("Amounts Not Due"; rec."FBM_Amounts Not Due")
                {
                    Caption = 'Amounts Not Due';
                }
                field("Total Balance"; rec."FBM_Current Month" + rec."FBM_1 Month" + rec."FBM_2 Months" + rec."FBM_3 Months" + rec."FBM_4 Months" + rec."FBM_5 Months" + rec."FBM_6 Months" + rec."FBM_7 Months" + rec."FBM_8 Months" + rec."FBM_9 Months" + rec."FBM_10 Months" + rec."FBM_11 Months" + rec."FBM_12 Months")
                {
    ...
    begin
        ...
        CASE CalculateNumberOfColumns OF
            ...
            1:
                Amt := rec."FBM_Current Month";

            2:
                Amt := rec."FBM_Current Month" + rec."FBM_1 Month";

            3:
                Amt := rec."FBM_Current Month" + rec."FBM_1 Month" + rec."FBM_2 Months";

            4:
                Amt := rec."FBM_Current Month" + rec."FBM_1 Month" + rec."FBM_2 Months" + rec."FBM_3 Months";

            5:
                Amt := rec."FBM_Current Month" + rec."FBM_1 Month" + rec."FBM_2 Months" + rec."FBM_3 Months" + rec."FBM_4 Months";

            6:
                Amt := rec."FBM_Current Month" + rec."FBM_1 Month" + rec."FBM_2 Months" + rec."FBM_3 Months" + rec."FBM_4 Months" + rec."FBM_5 Months";

            7:
                Amt := rec."FBM_Current Month" + rec."FBM_1 Month" + rec."FBM_2 Months" + rec."FBM_3 Months" + rec."FBM_4 Months" + rec."FBM_5 Months" + rec."FBM_6 Months";
        END;
