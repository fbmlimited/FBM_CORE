page 60106 "FBM_ApprReqEntries NewM_CO"
{
    ...
    Editable = false;
    PageType = List;
    SourceTable = FBM_ApprovalEntryM;
        ...
        repeat
            ...
            if compinfo.FBM_EnAppr then begin
                ...
                repeat
                    ...
                    apprentry.CalcFields("Pending Approvals");
                    ...
                    apprentry.CalcFields("Number of Approved Requests");
                    apprentryM."Number of Approved Requests" := apprentry."Number of Approved Requests";
                    apprentry.CalcFields("Number of Rejected Requests");
                    ...
                    apprentry.CalcFields("Related to Change");
    ...
    var
        ...
        apprentryM: record FBM_ApprovalEntryM;
    ...
    local procedure FormatField(Rec: Record FBM_ApprovalEntryM): Boolean
    begin
