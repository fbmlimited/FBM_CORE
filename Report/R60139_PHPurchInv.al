report 60139 "FBM_PurchaseInvoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/R60139_PHPurchInv.rdl';
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            begin
                ...
                if PostApprovalEntries.findlast then
                    enmsg := (purchsetup.FBM_Enable_CompMsg) and (PostApprovalEntries.Status = PostApprovalEntries.Status::Approved);
